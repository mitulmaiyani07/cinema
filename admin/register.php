...
if (isset($_POST['add_create'])) {
  ...
  if ($password === $confirm_password) {
    $sql = "insert into users (user_name,email,phone_no,password,user_type_id,created_at,updated_at,is_active,is_deleted) values ('$user_name','$email','$phone_no','$password','$user_type_id',now(),now(),true)";
      ...
      <div class="flex-1 h-full max-w-xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
        ...
        <div class="flex items-center justify-center p-6 sm:p-12 sm:w-1/2">
          <div class="w-full">
            ...
            href="dashboard.php" name="add_create">
             Create account
            </a>
